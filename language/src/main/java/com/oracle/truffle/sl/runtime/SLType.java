...
public final class SLType implements TruffleObject {
    ...
    public static final SLType PATTERN = new SLType("Pattern", (l, v) -> v instanceof SLPattern);
     ...
     */
    @CompilationFinal(dimensions = 1) public static final SLType[] PRECEDENCE = new SLType[]{NULL, NUMBER, STRING, BOOLEAN, PATTERN, FUNCTION, OBJECT};
